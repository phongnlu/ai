...
A curated AI news reader that crawls RSS sources, filters and summarizes articles, and serves them in a clean UI with search, category filters, brand filters, bookmarks, dark mode, PWA install, push notifications, and multilingual translation.
